...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="mb-0 text-primary text-uppercase"><i class="fa-solid fa-shrimp"></i> 好蝦影城</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="" class="btn btn-primary rounded-0 py-2 px-lg-4 d-none d-lg-block">線上訂票<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
            ...
            <div class="row g-4">
                <!-- 這樣是一組start -->
                    <?php
                        ...
                        $rows = $Movie->all(" where `ondate`>='$ondate' && `ondate`<='$today' && `sh`=1 order by rank limit 6");
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                        <div class="bg-dark d-flex flex-shrink-0 align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="./img/03C0<?=$row['level'];?>.png" alt="">
                        </div>
                        <div class="ps-4">
                            <h3 class="text-uppercase mb-3"><?=$row['name'];?></h3>
                            <p><?=$row['intro'];?></p>
                            <span class="text-uppercase text-primary">上映日期：<?=$row['ondate'];?></span>
                        </div>
